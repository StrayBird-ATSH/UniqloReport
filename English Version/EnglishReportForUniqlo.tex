...
\hypertarget{language-assistance-japanese-ja}{%
\section*{Language Assistance (Japanese,
JA)}\label{language-assistance-japanese-ja}}
\addcontentsline{toc}{section}{Language Assistance (Japanese, JA)}

If you need assistance in reading English, you can find the Japanese
version of this essay from the web address below:

\url{https://github.com/StrayBird-ATSH/UniqloReport/blob/master/Japanese\%20Version/EssayJapanese}
